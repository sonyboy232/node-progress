...
function ProgressBar(fmt, options) {
  ...
  if (options.forceTTY === true && !this.stream.isTTY) { // only works for stderr
...
ProgressBar.prototype.render = function (tokens, force) {
  ...
  this.tokenData.elapsed.raw = (new Date()) - this.start;
  ...
  this.tokenData.rate.formatted = (!this.tokenData.rate.raw ? 0 : this.tokenData.rate.raw).toFixed(2);
